...
```{r Histogram - Total Steps per day,echo=T}
...
```{r Line plot - Avg steps per interval,echo=T}
...
```{r Missing Data Visualization,echo=T}
library("VIM")
...
```{r Histogram - Total Steps per day including imputated values,echo=T}
...
```{r Line plots - Weekend and Weekday interval step patterns,echo=T}
